...
Es importante señalar que la arquitectura del sistema parametriza el modelo como una variable de configuración, lo que permite actualizarlo sin modificar el resto de la implementación. Dado que OpenAI publica periódicamente nuevas versiones dentro de la misma familia de modelos, el sistema está diseñado para incorporar versiones posteriores de forma transparente.

Para despliegues futuros donde se requieran modelos de código abierto, los resultados sugieren que alternativas como Llama podrían ser viables incorporando mecanismos adicionales de validación y corrección.
