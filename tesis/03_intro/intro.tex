...
El problema central que aborda este trabajo es: \textit{¿cómo automatizar la traducción de escenarios BDD en formato Gherkin al lenguaje intermedio formal IBDD, de manera que se preserve la semántica del comportamiento especificado y se generen representaciones formalmente válidas para alimentar herramientas de generación automática de casos de prueba?}
