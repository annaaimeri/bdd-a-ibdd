...
Este capítulo describe la implementación del sistema de traducción automática BDD$\rightarrow$IBDD. Se presenta la arquitectura general del pipeline, la definición formal de la gramática IBDD en Lark, el módulo de traducción basado en LLMs con su capa de abstracción agnóstica al proveedor, el módulo de validación sintáctica y el mecanismo de corrección iterativa.

\section{Arquitectura del Sistema}
\label{sec:arquitectura}

El sistema implementa un pipeline de cuatro etapas orquestado por la clase
\texttt{BDDToIBDDPipeline}, definida en el módulo principal. Cada etapa consume la salida de la anterior y guarda sus resultados en archivos JSON intermedios, lo que permite ejecutar las etapas de manera independiente durante el desarrollo y la depuración. A continuación se describe brevemente cada etapa; las secciones posteriores de este capítulo desarrollan en detalle los módulos correspondientes.
