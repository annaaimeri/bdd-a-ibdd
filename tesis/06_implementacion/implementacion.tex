...
\begin{enumerate}
  \item \textbf{Traducción} (Sección~\ref{sec:modulo-traduccion}).
    Recibe el archivo \texttt{Dataset.json} con los escenarios BDD en formato Gherkin y produce traducciones IBDD mediante un LLM, utilizando salidas estructuradas para garantizar conformidad con el esquema JSON esperado. Las traducciones se persisten incrementalmente en
    \texttt{output.json}.
